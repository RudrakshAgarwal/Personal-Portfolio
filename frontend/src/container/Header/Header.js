  ...
  return (
    <div className='app__header app__flex'>
        ...
        <div className='app__header-badge'>
          <div className="badge-cmp app__flex">
            ...
            <div style={{marginLeft: 20}}>
              ...
              <h1 className='head-text'>Rudraksh</h1>
            </div>
          </div>
      ...
      <motion.div whileInView={{ opacity: [0, 1] }} transition={{ duration: 0.5, delayChildren: 0.5 }} className='app__header-img'>
        ...
        <motion.img whileInView={{ scale: [0, 1] }} transition={{ duration: 1, ease: 'easeInOut' }} className='app__header-img overlay_circle' src={images.circle} alt='profile_circle' />

      </motion.div>


      <motion.div variants={scaleVariants} whileInView={scaleVariants.whileInView} className='app__header-circles'>
        {[images.react, images.java, images.mongoDB].map((circle, index) => (
